...
<script src="<?=WEBSITE_URL.VIEWS_FOLDER;?>js/jquery-1.10.2.min.js" type="text/javascript"></script>

<link href="<?=WEBSITE_URL.VIEWS_FOLDER;?>css/bootstrap.min.css" media="screen" rel="stylesheet" type="text/css" />
<link href="<?=WEBSITE_URL.VIEWS_FOLDER;?>css/font-awesome.min.css" media="screen" rel="stylesheet" type="text/css" />
<link href="<?=WEBSITE_URL.VIEWS_FOLDER;?>css/ace.min.css" media="screen" rel="stylesheet" type="text/css" />
