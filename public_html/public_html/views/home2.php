<?php defined("WEB_APP") or die("Please wait ... <META http-equiv=\"refresh\" content=\"0; url=".WEBSITE_URL."\" />"); echo $page; ?>
...
<div class="tabbable">
    <ul id="" class="nav nav-tabs">
        ...
        <li<?php if($page == 'vetiepkhach') echo ' class="active"';?>>
			<a href="?page=vetiepkhach">
				<i class="blue icon-time bigger-110"></i> Vé tiếp khách
			</a>
		</li>
		<li<?php if($page == 'thanhtoan') echo ' class="active"';?>>
			<a href="?page=thanhtoan">
				<i class="red icon-shopping-cart bigger-110"></i> Thanh toán
			</a>
		</li>
        <li<?php if($page == 'ktv') echo ' class="active"';?>>
			<a href="?page=ktv">
        ...
        <li<?php if($page == 'chitieu') echo ' class="active"';?>>
			<a href="?page=chitieu">
...
<style>.tab-content>.tab-pane, .pill-content>.pill-pane {
